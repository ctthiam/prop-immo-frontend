...
export default function ProprietaireLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (user.role !== 'PROPRIETAIRE') {
        setError('Accès réservé aux propriétaires');
        return;
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Espace Propriétaire</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-semibold text-slate-800">Connexion Propriétaire</h2>
          </div>
        ...
        <p className="text-center text-slate-400 text-xs mt-6">
          PropAfric © 2026 — Espace Propriétaire
        </p>
      </div>
    </div>
  );
